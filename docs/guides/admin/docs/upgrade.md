...
- The feature "Episode ID Roles" is now a core feature: enabled by default with no option to disable.
  If you have not used this feature before, you'll need to perform an index rebuild. See [Rebuild the index](#index-rebuild) for
  details. [[#6696](https://github.com/opencast/opencast/pull/6696)]
