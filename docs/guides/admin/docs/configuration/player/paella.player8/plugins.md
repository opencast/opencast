...
[org.opencast.paella.matomo.userTrackingDataPlugin](https://polimediaupv.github.io/paella-opencast/reference/paella-opencast-plugins/plugin_matomo_usertrackingdataplugin/)     | Enables user statistics gathering via [a Matomo service](../../admin-ui/statistics/matomo-statistics-provider.md) to track usage data.
...
[org.opencast.paella.quizPlugin](https://polimediaupv.github.io/paella-opencast/reference/paella-opencast-plugins/plugin_quizplugin/)) | Allows the display of quizzes
[org.opencast.paella.textboxPlugin](https://polimediaupv.github.io/paella-opencast/reference/paella-opencast-plugins/plugin_textboxplugin/)) | Allows the display of textboxes
