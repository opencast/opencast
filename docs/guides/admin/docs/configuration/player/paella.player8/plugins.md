...
[org.opencast.paella.matomo.userTrackingDataPlugin](https://polimediaupv.github.io/paella-opencast/reference/paella-opencast-plugins/plugin_matomo_usertrackingdataplugin/)     | Enables user statistics gathering via [a Matomo service](../../../configuration/admin-ui/statistics/matomo-statistics-provider/) to track usage data.
