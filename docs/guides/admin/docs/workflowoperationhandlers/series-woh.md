...
|apply-acl         |`true`                                      |Whether the ACL should be applied or not. Note: Existing episode ACLs may still influence the effective permissions depending on [merge rules](../../configuration/acl/#series-and-episode-rules).|`false`|
