...
*Note that this is not a comprehensive guide of all possible ways to install Matterhorn. It's more like a guide to good
...
Later on you want to have one common user on all your systems that has access to the share as you don't want everyone to
...
Don't forget to set the user also for the remote servers and grant them the necessary rights. Additionally, you need to
