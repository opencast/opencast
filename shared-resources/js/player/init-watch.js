    ...
    $.ajax({
        ...
        success: function(data)
        {
          ...
          $.ajax({
            ...
            {
                var admin_role = data.org.adminRole;
                if ($.inArray(admin_role, data.roles) == -1) {
                  $('#oc_title-bar-logo-image').attr('href', components.engage + '/engage/ui');
                  $("#oc_title-bar-gallery-link").hide();
                } 
                else 
                {
                  $('#oc_title-bar-logo-image').attr('href', components.admin);
                  $("#oc_title-bar-gallery-link").attr('href', components.engage + '/engage/ui');
                }
            }
          });
        }
