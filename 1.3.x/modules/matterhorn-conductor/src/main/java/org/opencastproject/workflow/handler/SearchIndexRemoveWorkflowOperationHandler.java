 ...
 */
public class SearchIndexRemoveWorkflowOperationHandler extends AbstractWorkflowOperationHandler {
  private static final Logger logger = LoggerFactory.getLogger(SearchIndexRemoveWorkflowOperationHandler.class);
  ...
  public WorkflowOperationResult start(WorkflowInstance workflowInstance, JobContext context) throws WorkflowOperationException {
    ...
    try {
      ...
      searchService.delete(mediaPackage.getIdentifier().toString());
      logger.debug("Remove operation complete");
