...
interface WaveformService {
    ...
    fun createWaveformImage(sourceTrack: Track, pixelPerMinute: Int, minWidth: Int, maxWidth: Int, height: Int, color: String): Job

    companion object {

        /** Job type  */
        val JOB_TYPE = "org.opencastproject.waveform"
    }
}
