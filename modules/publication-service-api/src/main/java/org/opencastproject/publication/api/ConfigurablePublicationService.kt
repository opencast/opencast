...
interface ConfigurablePublicationService {
    ...
    fun replace(mediaPackage: MediaPackage, channelId: String, addElements: Collection<MediaPackageElement>,
                retractElementIds: Set<String>): Job
     ...
     */
    @Throws(PublicationException::class, MediaPackageException::class)
    fun replaceSync(mediaPackage: MediaPackage, channelId: String, addElements: Collection<MediaPackageElement>,
                    retractElementIds: Set<String>): Publication

    companion object {

        val JOB_TYPE = "org.opencastproject.publication.configurable"
    }
}
