  ...
  return (
      <>
          ...
          <section className="modal active modal-open"
                              ...
                              <div className="obj-container">
                                  <table className="main-tbl">
                                      ...
                                      {selectedSeries.map((series, key) => (
                                          <tr key={key} className={cn({error: !deleteWithSeriesAllowed && series.selected && series.hasEvents})}>
                                              <td>
                                                  <input type="checkbox"
                                                         name="selection"
                                              ...
                                              <td>
                                                  ...
                                                  {series.organizers.map((organizer, key) => (
                                                      <span className="metadata-entry" key={key}>{organizer}</span>
                                                  ))}
                                              </td>
              ...
              <footer>
                  <button onClick={() => deleteSelectedSeries()}
...
const mapDispatchToProps = dispatch => ({
    deleteMultipleSeries: selectedSeries => dispatch(deleteMultipleSeries(selectedSeries))
});
