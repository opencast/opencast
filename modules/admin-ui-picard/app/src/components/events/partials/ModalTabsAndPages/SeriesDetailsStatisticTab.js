...
import {getStatistics, hasStatisticsError} from "../../../../selectors/seriesDetailsSelectors";
...
const SeriesDetailsStatisticTab = ({ seriesId, header,
                                       statistics, hasError,
...
const mapDispatchToProps = dispatch => ({
    recalculateStatistics: (seriesId, providerId, from, to, dataResolution, timeMode) => dispatch(fetchSeriesStatisticsValueUpdate(seriesId, providerId, from, to, dataResolution, timeMode)),
});

export default connect(mapStateToProps, mapDispatchToProps)(SeriesDetailsStatisticTab);
