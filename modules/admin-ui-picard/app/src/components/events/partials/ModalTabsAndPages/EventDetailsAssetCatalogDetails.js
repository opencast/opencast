 ...
 */
const EventDetailsAssetCatalogDetails = ({ eventId, t, setHierarchy,
                                            catalog, isFetching }) => {
                        ...
                        <div className="obj-container">
                            ...
                            {isFetching || (
                                <tbody>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.CATALOGS.DETAILS.ID") /* Id */}
                                        </td>
                                        <td>{catalog.id}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.CATALOGS.DETAILS.TYPE") /* Type */}
                                        </td>
                                        <td>{catalog.type}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.CATALOGS.DETAILS.MIMETYPE") /* Mimetype */}
                                        </td>
                                    ...
                                    {(!!catalog.size && catalog.size) > 0 && (
                                        <tr>
                                            <td>
                                                {t("EVENTS.EVENTS.DETAILS.ASSETS.CATALOGS.DETAILS.SIZE") /* Size */}
                                            </td>
                                    ...
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.CATALOGS.DETAILS.CHECKSUM") /* Checksum */}
                                        </td>
                                        <td>{catalog.checksum}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.CATALOGS.DETAILS.REFERENCE") /* Reference */}
                                        </td>
                                        <td>{catalog.reference}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.CATALOGS.DETAILS.TAGS") /* Tags */}
                                        </td>
                                        <td>{(!!catalog.tags && catalog.tags.length > 0)? catalog.tags.join(', ') : null}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.CATALOGS.DETAILS.URL") /* Link */}
                                        </td>
                                        <td>
