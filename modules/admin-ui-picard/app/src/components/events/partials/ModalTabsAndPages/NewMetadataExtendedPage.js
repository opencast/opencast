...
const NewMetadataExtendedPage = ({ previousPage, nextPage, formik, extendedMetadataFields }) => {
                ...
                <div className="modal-body">
                    <div className="full-col">
                        {//iterate through metadata catalogs
                            !!extendedMetadataFields && extendedMetadataFields.length > 0 &&
                            ...
                            <div className="obj tbl-list" key={index}>
                                ...
                                <div className="obj-container">
                                    <table className="main-tbl">
                                        <tbody>
                                        {!!catalog.fields && catalog.fields.map((field, key) => (
