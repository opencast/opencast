...
import {getAssetMedia, isFetchingAssets} from "../../../../selectors/eventDetailsSelectors";
 ...
 */
const EventDetailsAssetMedia = ({ eventId, t, setHierarchy,
                                    media, isFetching,
                                    loadMediaDetails }) => {
                            ...
                            <table cellPadding="0" cellSpacing="0" className="main-tbl">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.MEDIA.MIMETYPE") /* Mimetype */}
                                        </th>
                                        <th>
...
const mapDispatchToProps = dispatch => ({
    loadMediaDetails: (eventId, mediaId) => dispatch(fetchAssetMediaDetails(eventId, mediaId))
});

export default connect(mapStateToProps, mapDispatchToProps)(EventDetailsAssetMedia);
