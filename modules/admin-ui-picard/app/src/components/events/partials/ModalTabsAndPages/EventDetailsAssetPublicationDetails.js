    ...
    return (
        <div className="modal-content">
            ...
            <EventDetailsTabHierarchyNavigation
                ...
                translationKey1={"EVENTS.EVENTS.DETAILS.ASSETS.PUBLICATIONS.DETAILS.TITLE"}
                        ...
                        <div className="obj-container">
                            ...
                            {isFetching || (
                                <tbody>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.PUBLICATIONS.DETAILS.ID") /* Id */}
                                        </td>
                                        <td>{publication.id}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.PUBLICATIONS.DETAILS.TYPE") /* Type */}
                                        </td>
                                        <td>{publication.type}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.PUBLICATIONS.DETAILS.MIMETYPE") /* Mimetype */}
                                        </td>
                                    ...
                                    {(!!publication.size && publication.size > 0) && (
                                        <tr>
                                            <td>
                                                {t("EVENTS.EVENTS.DETAILS.ASSETS.PUBLICATIONS.DETAILS.SIZE") /* Size */}
                                            </td>
                                    ...
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.PUBLICATIONS.DETAILS.CHANNEL") /* Channel */}
                                        </td>
                                        <td>{publication.channel}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.PUBLICATIONS.DETAILS.REFERENCE") /* Reference */}
                                        </td>
                                        <td>{publication.reference}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.PUBLICATIONS.DETAILS.TAGS") /* Tags */}
                                        </td>
                                        <td>{(!!publication.tags && publication.tags.length > 0)? publication.tags.join(', ') : null}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.PUBLICATIONS.DETAILS.URL") /* Link */}
                                        </td>
                                        <td>
                                            <a className="fa fa-external-link" href={publication.url}/>
                                        </td>
                                    </tr>
                                </tbody>
                            )}
