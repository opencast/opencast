...
import {getAssetAttachmentDetails, isFetchingAssets} from "../../../../selectors/eventDetailsSelectors";
    ...
    return (
        <div className="modal-content">
            ...
            <EventDetailsTabHierarchyNavigation
                ...
                translationKey1={"EVENTS.EVENTS.DETAILS.ASSETS.ATTACHMENTS.DETAILS.TITLE"}
                        ...
                        <div className="obj-container">
                            ...
                            {isFetching || (
                                <tbody>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.ATTACHMENTS.DETAILS.ID") /* Id */}
                                        </td>
                                        <td>{attachment.id}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.ATTACHMENTS.DETAILS.TYPE") /* Type */}
                                        </td>
                                        <td>{attachment.type}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.ATTACHMENTS.DETAILS.MIMETYPE") /* Mimetype */}
                                        </td>
                                    ...
                                    {(!!attachment.size && attachment.size > 0) && (
                                        <tr>
                                            <td>
                                                {t("EVENTS.EVENTS.DETAILS.ASSETS.ATTACHMENTS.DETAILS.SIZE") /* Size */}
                                            </td>
                                    ...
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.ATTACHMENTS.DETAILS.CHECKSUM") /* Checksum */}
                                        </td>
                                        <td>{attachment.checksum}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.ATTACHMENTS.DETAILS.REFERENCE") /* Reference */}
                                        </td>
                                        <td>{attachment.reference}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.ATTACHMENTS.DETAILS.TAGS") /* Tags */}
                                        </td>
                                        <td>{(!!attachment.tags && attachment.tags.length > 0)? attachment.tags.join(', ') : null}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {t("EVENTS.EVENTS.DETAILS.ASSETS.ATTACHMENTS.DETAILS.URL") /* Link */}
                                        </td>
                                        <td>
                                            <a className="fa fa-external-link" href={attachment.url}/>
                                        </td>
                                    </tr>
                                </tbody>
                            )}
