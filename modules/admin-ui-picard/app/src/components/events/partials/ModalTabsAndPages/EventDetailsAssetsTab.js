        ...
        <div className="modal-content">
            <div className="modal-body">
                ...
                <div className="full-col">
                    <div className="obj tbl-container operations-tbl"> {/* Assets */}
                        <header>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a className="details-link"
                                                   onClick={() => openSubTab('asset-attachments', 'attachment')}>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {(assets.catalogs > 0) && (
                                                    <a className="details-link"
                                                       onClick={() => openSubTab('asset-catalogs', 'catalog')}>
                                                        {t("EVENTS.EVENTS.DETAILS.ASSETS.DETAILS") /* Details */ }
                                                    </a>
                                                )}
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {(assets.publications > 0) && (
                                                    <a className="details-link"
                                                       onClick={() => openSubTab('asset-publications', 'publication')}>
                                                        {t("EVENTS.EVENTS.DETAILS.ASSETS.DETAILS") /* Details */ }
                                                    </a>
                                                )}
                                            </td>
...
export default connect(mapStateToProps, mapDispatchToProps)(EventDetailsAssetsTab);