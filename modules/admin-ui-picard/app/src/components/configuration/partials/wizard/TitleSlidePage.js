            ...
            <div className="modal-content">
                <div className="modal-body">
                    <div className="full-col">
                        <p className="tab-description">{t('CONFIGURATION.THEMES.DETAILS.TITLE.DESCRIPTION')}</p>
                    </div>
                    {/*todo: Notification*/}
                    <div className="obj">
                        ...
                        <div className="obj-container content-list padded">
                            ...
                            <div className="list-row">
                                <div className="header-column">
                                    <label className="large">{t('CONFIGURATION.THEMES.DETAILS.TITLE.ENABLE')}</label>
                                </div>
                                {/* Checkbox for activating title slide */}
                                <div className="content-column">
                                    <div className="content-container">
                                        <Field id="titleSlide-toggle"
                                               type="checkbox" name="titleSlideActive"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {formik.values.titleSlideActive && (
                        <div className="obj">
                            <header>{t('CONFIGURATION.THEMES.DETAILS.TITLE.BACKGROUND')}</header>
                                ...
                                <div className="file-upload">
                                    <div className="form-container">
                                        ...
                                        <div className="row">
                                            ...
                                            <label>{t('CONFIGURATION.THEMES.DETAILS.TITLE.EXTRACT')}</label>
                                        </div>
                                        <div className="row">
                                            <Field type="radio"
                                                   value="upload"
                                            ...
                                            <label>{t('CONFIGURATION.THEMES.DETAILS.TITLE.UPLOAD')}</label>
                                        </div>
                                    </div>
                                </div>
