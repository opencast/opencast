...
export const isLoadingScheduling = state => state.events.schedulingInfo.isLoading;
export const getSchedulingEditedEvents = state => state.events.schedulingInfo.editedEvents;
export const getSchedulingSeriesOptions = state => state.events.schedulingInfo.seriesOptions;
