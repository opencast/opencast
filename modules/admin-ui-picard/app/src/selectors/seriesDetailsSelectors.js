...
export const hasStatistics = state => state.seriesDetails.statistics.length > 0;
export const getStatistics = state => state.seriesDetails.statistics;
export const hasStatisticsError = state => state.seriesDetails.hasStatisticsError;
export const isFetchingStatistics = state => state.seriesDetails.fetchingStatisticsInProgress;
