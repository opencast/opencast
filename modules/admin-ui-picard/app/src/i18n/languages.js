...
* */
const languages = [
    { code: 'en-GB', long: 'English', rtl: false, flag: GBFlag, dateLocale: enGBDate },
    { code: 'en-US', long: 'English', rtl: false, flag: USFlag, dateLocale: enUSDate },
    { code: 'da', long: 'Dansk', rtl: false, flag: DKFlag, dateLocale: daDate },
    { code: 'de', long: 'Deutsch', rtl: false, flag: DEFlag, dateLocale: deDate },
    { code: 'el', long: 'Ελληνικά', rtl: false, flag: GRFlag, dateLocale: elDate },
    { code: 'es', long: 'Español', rtl: false, flag: ESFlag, dateLocale: esDate },
    { code: 'fr', long: 'Français',rtl: false, flag: FRFlag, dateLocale: frDate },
    { code: 'gl', long: 'Galego', rtl: false, flag: ESFlag2, dateLocale: glDate },
    { code: 'he', long: 'עברית' , rtl: true, flag: ILFlag, dateLocale: heDate},
    { code: 'it', long: 'Italiano', rtl: false, flag: ITFlag, dateLocale: itDate },
    { code: 'nl', long: 'Nederlands', rtl: false, flag: NLFlag, dateLocale: nlDate },
    { code: 'pl', long: 'Polski', rtl: false, flag: PLFlag, dateLocale: plDate },
    { code: 'sl', long: 'Slovenščina', rtl: false, flag: SIFlag, dateLocale: slDate },
