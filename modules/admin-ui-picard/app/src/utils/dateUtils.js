...
const changeStart = (eventId, start, formikValues, setFieldValue, checkConflicts) => {
    ...
    setFieldValue('scheduleEndDate', new Date(endDate.setHours(0, 0, 0)).toISOString());
    setFieldValue('scheduleStartDate', new Date(startDate.setHours(0, 0, 0)).toISOString());
...
export const changeStartDate = (value, formikValues, setFieldValue,
                                eventId='', checkConflicts=null) => {
    changeStart(
        eventId,
        {
            date: value,
...
export const changeStartHour = async (value, formikValues, setFieldValue,
                                      eventId='', checkConflicts=null) => {
    changeStart(
        eventId,
        {
...
export const changeStartMinute = async (value, formikValues, setFieldValue,
                                        eventId='', checkConflicts=null) => {
    changeStart(
        eventId,
        {
...
const changeEnd = (eventId, end, formikValues, setFieldValue, checkConflicts) => {
...
export const changeEndHour = async (value, formikValues, setFieldValue,
                                    eventId='', checkConflicts=null) => {
    changeEnd(
        eventId,
        {
...
export const changeEndMinute = async (value, formikValues, setFieldValue,
                                      eventId='', checkConflicts=null) => {
    changeEnd(
        eventId,
        {
...
const changeDuration = (eventId, duration, formikValues, setFieldValue, checkConflicts) => {
...
export const changeDurationHour = async (value, formikValues, setFieldValue,
                                         eventId='', checkConflicts=null) => {
    changeDuration(
        eventId,
        {
...
export const changeDurationMinute = async (value, formikValues, setFieldValue,
                                           eventId='', checkConflicts=null) => {
    changeDuration(
        eventId,
        {
...
// changes the start in the formik
const changeStartMultiple = (eventId, start, formikValues, setFieldValue, checkConflicts) => {
    const startDate = makeDate(start.date, start.hour, start.minute);
    let endDate = makeDate(start.date, formikValues.scheduleEndHour, formikValues.scheduleEndMinute);
    ...
    endDate = makeDate(formikValues.scheduleEndDate, formikValues.scheduleEndHour, formikValues.scheduleEndMinute);
...
export const changeStartDateMultiple = (value, formikValues, setFieldValue,
                                eventId='', checkConflicts=null) => {
    changeStartMultiple(
        eventId,
        {
...
export const changeStartHourMultiple = async (value, formikValues, setFieldValue,
                                      eventId='', checkConflicts=null) => {
    changeStartMultiple(
        eventId,
        {
...
export const changeStartMinuteMultiple = async (value, formikValues, setFieldValue,
                                        eventId='', checkConflicts=null) => {
    changeStartMultiple(
        eventId,
        {
...
// changes the end in the formik
export const changeEndDateMultiple =  async (value, formikValues, setFieldValue,
                                    eventId='', checkConflicts=null) => {
    const endDate = makeDate(value, formikValues.scheduleEndHour, formikValues.scheduleEndMinute);
    const startDate = makeDate(formikValues.scheduleStartDate, formikValues.scheduleStartHour, formikValues.scheduleStartMinute);
...
// changes the end in the formik
const changeEndMultiple = (eventId, end, formikValues, setFieldValue, checkConflicts) => {
...
export const changeEndHourMultiple = async (value, formikValues, setFieldValue,
                                    eventId='', checkConflicts=null) => {
    changeEndMultiple(
        eventId,
        {
...
export const changeEndMinuteMultiple = async (value, formikValues, setFieldValue,
                                      eventId='', checkConflicts=null) => {
    changeEndMultiple(
        eventId,
        {
...
// changes the duration in the formik
const changeDurationMultiple = (eventId, duration, formikValues, setFieldValue, checkConflicts) => {

    const startDate = makeDate(formikValues.scheduleStartDate, formikValues.scheduleStartHour, formikValues.scheduleStartMinute);
    const endDate = makeDate(formikValues.scheduleEndDate, formikValues.scheduleStartHour, formikValues.scheduleStartMinute);
...
export const changeDurationHourMultiple = async (value, formikValues, setFieldValue,
                                         eventId='', checkConflicts=null) => {
...
export const changeDurationMinuteMultiple = async (value, formikValues, setFieldValue,
                                           eventId='', checkConflicts=null) => {
    changeDurationMultiple(
        eventId,
        {
