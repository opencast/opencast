...
export const checkValidityUpdateScheduleEventSelection = (formikValues, user) => {
    if (formikValues.events.length > 0) {
        if (isAllScheduleEditable(formikValues.events)
...
export const checkSchedulingConflicts = async (formikValues, setConflicts, checkConflicts, addNotification) => {
