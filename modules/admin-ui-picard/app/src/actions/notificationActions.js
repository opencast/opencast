...
export const REMOVE_NOTIFICATION_WIZARD_FORM = 'REMOVE_NOTIFICATION_WIZARD_FORM';
export const REMOVE_NOTIFICATION_WIZARD_ACCESS = 'REMOVE_NOTIFICATION_WIZARD_ACCESS';
