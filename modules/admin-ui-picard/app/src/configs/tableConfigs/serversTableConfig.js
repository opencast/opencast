...
import ServersMeanRunCell from "../../components/systems/partials/ServersMeanRunCell";
import ServersMeanQueueCell from "../../components/systems/partials/ServersMeanQueueCell";
...
export const serversTableConfig = {
    columns: [{
        ...
        template: 'ServersMeanRunCell',
        name:  'meanRunTime',
        label: 'SYSTEMS.SERVERS.TABLE.MEAN_RUN_TIME',
        sortable: true
    }, {
        template: 'ServersMeanQueueCell',
        name:  'meanQueueTime',
...
export const serversTemplateMap = {
    ...
    'ServersMeanRunCell': ServersMeanRunCell,
    'ServersMeanQueueCell': ServersMeanQueueCell,
