  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        ...
        this.container.html('<a class="chosen-single chosen-default" tabindex="-1"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" /></div><ul opencast-scroll-glue class="chosen-results"></ul></div>');
      }
    ...
    Chosen.prototype.register_observers = function() {
      ...
      this.form_field_jq.bind("chosen:updated.chosen", function(evt) {
        ...
        if (null != _this.result_highlight) {
          text_check = _this.result_highlight[0].innerHTML;
