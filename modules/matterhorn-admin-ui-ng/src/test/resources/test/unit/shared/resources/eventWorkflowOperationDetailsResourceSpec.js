describe('Event Workflow Operation API Resource', function () {
    ...
    describe('#get', function () {
        beforeEach(function () {
            ...
            $httpBackend.whenGET('/admin-ng/event/40518/workflows/8695/operations/1303.json')
        ...
        it('queries the API', function () {
            $httpBackend.expectGET('/admin-ng/event/40518/workflows/8695/operations/1303.json').respond(getJSONFixture('admin-ng/event/40518/workflows/8695/operations/1303.json'));
            EventWorkflowOperationDetailsResource.get({ id0: '40518', id1: '8695', id2: '1303' });
            $httpBackend.flush();
        });

        it('returns the parsed JSON', function () {
            $httpBackend.expectGET('/admin-ng/event/40518/workflows/8695/operations/1303.json').respond(getJSONFixture('admin-ng/event/40518/workflows/8695/operations/1303.json'));
            var data = EventWorkflowOperationDetailsResource.get({ id0: '40518', id1: '8695', id2: '1303' });
            $httpBackend.flush();
