...
public class StateRestEndpointTest {
  ...
  public void testGetRecordingsNoneGet() throws Exception {
    ...
    Assert.assertTrue((Boolean) getXPath(parsedResponse, "/*[local-name() = 'recording-state-updates']",
  ...
  public void testGetRecordingsPresentGet() throws Exception {
    ...
    Assert.assertTrue((Boolean) getXPath(parsedResponse, "//*[local-name() = 'recording-state-update']",
            XPathConstants.BOOLEAN));

    Assert.assertTrue((Boolean) getXPath(parsedResponse,
            "//*[local-name() = 'recording-state-update']/*[local-name() = 'name']", XPathConstants.BOOLEAN));
    Assert.assertTrue((Boolean) getXPath(parsedResponse,
            "//*[local-name() = 'recording-state-update']/*[local-name() = 'state']", XPathConstants.BOOLEAN));
    Assert.assertTrue((Boolean) getXPath(parsedResponse,
            "//*[local-name() = 'recording-state-update']/*[local-name() = 'time-since-last-update']",
            XPathConstants.BOOLEAN));
  ...
  protected Object getXPath(Document document, String path, QName returnType) throws XPathExpressionException,
