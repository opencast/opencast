...
/**
 * Tests the functionality of the youtube publication rest endpoint
 */
public class YouTubePublicationRestEndpointTest {
  ...
  public static void setupClass() throws Exception {
    logger.info("Running " + YouTubePublicationRestEndpointTest.class.getName());
  }

  @Before
  public void setUp() throws Exception {
    client = Main.getClient();
    retract(getSampleMediaPackage());
  }
  ...
  @Test
  public void testPublishAndRetract() throws Exception {
    // -----------------------------------------------------
    ...
    // -----------------------------------------------------
    retract(getSamplePublishedMediaPackage());
  }

  private void retract(String mediaPackageXml) throws Exception, UnsupportedEncodingException, IOException,
  ...
  protected String getSamplePublishedMediaPackage() throws Exception {
    String template = IOUtils.toString(
            getClass().getClassLoader().getResourceAsStream("mediapackage-youtube-published.xml"), "UTF-8");
    return template.replaceAll("@SAMPLES_URL@", BASE_URL + "/workflow/samples");
  }
