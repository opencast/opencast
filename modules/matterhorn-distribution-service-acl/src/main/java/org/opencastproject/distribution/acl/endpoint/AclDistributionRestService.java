...
@RestService(name = "localdistributionservice", title = "Local Distribution Service", abstractText = "This service "
        + "distributes access control lists to the Matterhorn feed and engage services.", notes = {
...
public class AclDistributionRestService extends AbstractJobProducerEndpoint {
  ...
  /** The logger */
  private static final Logger logger = LoggerFactory.getLogger(AclDistributionRestService.class);
