...
interface MediaInspectionService {
     ...
     */
    @Throws(MediaInspectionException::class)
    fun inspect(uri: URI, options: Map<String, String>): Job
    ...
    fun enrich(original: MediaPackageElement, override: Boolean): Job
     ...
     */
    @Throws(MediaInspectionException::class, MediaPackageException::class)
    fun enrich(original: MediaPackageElement, override: Boolean, options: Map<String, String>): Job
    ...
    companion object {
         ...
         */
        val JOB_TYPE = "org.opencastproject.inspection"
    }
}
