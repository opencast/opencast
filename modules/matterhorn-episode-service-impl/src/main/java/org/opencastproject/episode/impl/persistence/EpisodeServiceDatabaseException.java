 ...
 */
public class EpisodeServiceDatabaseException extends Exception {
   ...
   * Create exception.
   */
  public EpisodeServiceDatabaseException() {
  }
   ...
   * @param cause
   */
  public EpisodeServiceDatabaseException(String message, Throwable cause) {
    super(message, cause);
  }
