...
public class PluginData {
  ...
  String name;
  String description;
  boolean providesStaticResources;
  boolean providesRestEndpoint;
  ...
  public PluginData(ServiceReference sref) {
    ...
    try {
      ...
      providesRestEndpoint = providesRest != null 
              && (providesRest.equalsIgnoreCase("true") || providesRest.equalsIgnoreCase("yes"));
