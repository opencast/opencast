...
public class SchedulerMigrationServiceTest {
  ...
  public void setUp() throws Exception {
    ...
    assetManager.setProperty(Property.mk(PropertyId.mk("mp1", SchedulerMigrationService.SCHEDULER_NAMESPACE, SchedulerMigrationService.REVIEW_DATE_CONFIG), Value.mk(new Date(101))));
    assetManager.setProperty(Property.mk(PropertyId.mk("mp1", SchedulerMigrationService.SCHEDULER_NAMESPACE, SchedulerMigrationService.REVIEW_STATUS_CONFIG), Value.mk("status of mp1")));
    ...
    assetManager.setProperty(Property.mk(PropertyId.mk("mp2", SchedulerMigrationService.SCHEDULER_NAMESPACE, SchedulerMigrationService.REVIEW_DATE_CONFIG), Value.mk(new Date(201))));
    assetManager.setProperty(Property.mk(PropertyId.mk("mp2", SchedulerMigrationService.SCHEDULER_NAMESPACE, SchedulerMigrationService.REVIEW_STATUS_CONFIG), Value.mk("status of mp2")));
  ...
  public void testSchedulerMigration() throws Exception {
    ...
    assertEquals(new Date(101), entity.getReviewDate());
    assertEquals("status of mp1", entity.getReviewStatus());
    ...
    assertEquals(new Date(201), entity.getReviewDate());
    assertEquals("status of mp2", entity.getReviewStatus());
