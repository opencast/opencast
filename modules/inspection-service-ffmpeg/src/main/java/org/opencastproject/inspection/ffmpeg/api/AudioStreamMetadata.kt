...
class AudioStreamMetadata : StreamMetadata() {
    ...
    var samplingCount: Long? = null

    var replayGain: Float? = null
    var replayGainPeak: Float? = null

    var interleaveVideoFrames: Float? = null
    // ms
    var interleaveDuration: Int? = null
    // ms
    var interleavePreload: Int? = null
