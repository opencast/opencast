...
interface Attachment : MediaPackageElement {
    ...
    companion object {
        ...
        val TYPE: MediaPackageElement.Type = MediaPackageElement.Type.Attachment

        /** Element flavor definition  */
        val FLAVOR = MediaPackageElementFlavor("attachment", "(unkown)")
    }
}
