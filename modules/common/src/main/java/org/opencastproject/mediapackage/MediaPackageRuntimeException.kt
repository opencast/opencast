...
/**
 * This exception is used to wrap the checked [MediaPackageException] into a RuntimeException. This is useful to
 ...
 * the wrapped [MediaPackageException]
 */
(val wrappedException: MediaPackageException) : RuntimeException() {
    companion object {

        /** Serial version uid  */
        private val serialVersionUID = -1545569836535459336L
    }
}
