 ...
 */
interface MediaPackageObserver {
     ...
     * the added element
     */
    fun elementAdded(element: MediaPackageElement)
     ...
     * the removed element
     */
    fun elementRemoved(element: MediaPackageElement)
     ...
     */
    fun packageMoved(mediaPackage: MediaPackage)
