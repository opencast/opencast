...
interface Track : MediaPackageElement {
     ...
     *
     * @return `true` if the track has an audio stream
     */
     ...
     *
     * @return `true` if the track has a video stream
     */
    ...
    companion object {
         ...
         */
        val TYPE: MediaPackageElement.Type = MediaPackageElement.Type.Track
    }
}
