...
interface ManifestContributor {
     ...
     *
     *
     * For creating *[MediaPackageElement]s* from a manifest, please use
     * [MediaPackageElementBuilder.elementFromManifest]. All other objects
    ...
    fun toManifest(document: Document, serializer: MediaPackageSerializer): Node
