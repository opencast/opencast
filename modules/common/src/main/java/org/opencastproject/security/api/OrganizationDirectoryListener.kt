 ...
 */
interface OrganizationDirectoryListener {
     ...
     * the organization
     */
    fun organizationRegistered(organization: Organization)
     ...
     * the organization
     */
    fun organizationUnregistered(organization: Organization)
     ...
     * the organization
     */
    fun organizationUpdated(organization: Organization)
