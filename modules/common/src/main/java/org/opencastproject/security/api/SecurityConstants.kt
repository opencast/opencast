...
interface SecurityConstants {
    companion object {
        ...
        val AUTHORIZATION_HEADER = "X-Opencast-Matterhorn-Authorization"

        /** Header name for the desired organization  */
        val ORGANIZATION_HEADER = "X-Opencast-Matterhorn-Organization"

        /** Header name for the desired user  */
        val USER_HEADER = "X-Opencast-Matterhorn-User"

        /** Header name for running an operation as a desired user. Same as X-Opencast-Matterhorn-User.  */
        val RUN_AS_USER_HEADER = "X-RUN-AS-USER"

        /** Header name for the desired role  */
        val ROLES_HEADER = "X-Opencast-Matterhorn-Roles"

        /** Header name for running an operation with a desired role. Same as X-Opencast-Matterhorn-Roles.  */
        val RUN_WITH_ROLES = "X-RUN-WITH-ROLES"

        /** Name of the Opencast admin role  */
        val GLOBAL_ADMIN_ROLE = "ROLE_ADMIN"

        /** Name of the Opencast capture agent role  */
        val GLOBAL_CAPTURE_AGENT_ROLE = "ROLE_CAPTURE_AGENT"

        /** Name of the Opencast global sudo role  */
        val GLOBAL_SUDO_ROLE = "ROLE_SUDO"

        /** Name of the Opencast anonymous role  */
        val GLOBAL_ANONYMOUS_USERNAME = "anonymous"

        /** The roles associated with the Opencast system account  */
        val GLOBAL_SYSTEM_ROLES = arrayOf(GLOBAL_ADMIN_ROLE, GLOBAL_SUDO_ROLE)

        /** The roles associated with the Opencast capture agent account  */
        val GLOBAL_CAPTURE_AGENT_ROLES = arrayOf(GLOBAL_CAPTURE_AGENT_ROLE)
    }
