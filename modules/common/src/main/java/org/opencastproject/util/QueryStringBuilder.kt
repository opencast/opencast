...
(baseServicePath: String) {
    ...
    private val baseServicePath = ""

    init {
        sb = StringBuilder(baseServicePath)
     ...
     */
    fun add(key: String?, value: String?): QueryStringBuilder {
        if (key == null) {
            throw IllegalArgumentException("key can not be null")
        }
