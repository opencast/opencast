...
import org.opencastproject.userdirectory.brightspace.client.api.OrgUnit;
import org.opencastproject.userdirectory.brightspace.client.api.OrgUnitItem;
import org.opencastproject.userdirectory.brightspace.client.api.Role;
import org.opencastproject.userdirectory.brightspace.client.api.Type;
...
public class BrightspaceUserProviderInstanceTest {
  ...
  public void shouldReturnProviderName() {
    assertThat(brightspaceUserProviderInstance.getName(), is("brightspace"));
  }
