...
interface UrlSigningService {
     ...
     */
    fun accepts(baseUrl: String): Boolean
     ...
     * The number of seconds after now that the resource will become available; may be `null` (optional).
     * @param ipAddr
     * The IP address of the client that is allowed to view the resource; may be `null` (optional).
    ...
    fun sign(baseUrl: String, validUntilDuration: Long?, validFromDuration: Long?, ipAddr: String): String
     ...
     * @param validFrom
     * The date and time the resource will become available; may be `null` (optional).
     * @param ipAddr
     * The IP address of the client that is allowed to view the resource; may be `null` (optional).
     * @return A query string signature for this resource.
     * @throws UrlSigningException
     ...
     */
    @Throws(UrlSigningException::class)
    fun sign(baseUrl: String, validUntil: DateTime, validFrom: DateTime, ipAddr: String): String
}
