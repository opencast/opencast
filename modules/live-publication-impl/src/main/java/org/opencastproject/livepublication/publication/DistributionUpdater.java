...
import org.opencastproject.livepublication.util.CatalogAndAttachmentEquator;
...
public class DistributionUpdater {
  ...
  public List<MediaPackageElement> distributeElements(MediaPackage mp) throws LivePublicationException {
