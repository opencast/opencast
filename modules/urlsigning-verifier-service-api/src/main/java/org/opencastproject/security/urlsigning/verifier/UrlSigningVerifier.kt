...
interface UrlSigningVerifier {
     ...
     * @return A [ResourceRequest] object with the status of it being a valid request.
     */
    @Throws(UrlSigningException::class)
    fun verify(queryString: String, clientIp: String, baseUrl: String): ResourceRequest
     ...
     */
    @Throws(UrlSigningException::class)
    fun verify(queryString: String, clientIp: String, baseUrl: String, strict: Boolean): ResourceRequest
}
