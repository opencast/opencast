...
/**
 * An index implementation based on ElasticSearch that serves APIs like the Admin UI API and the External API with data
 * aggregated from multiple services.
 */
@Component(
        property = {
                "service.description=API Elasticsearch Index"
        },
        immediate = true,
        service = { ApiIndex.class }
)
public class ApiIndex extends AbstractElasticsearchIndex {

  /** The name of this index */
  private static final String INDEX_NAME = "api-index";
  ...
  private static final Logger logger = LoggerFactory.getLogger(ApiIndex.class);
