...
(private val mRequestData: InputStream?, private val length: Int, private val mStrContentType: String) : HttpServletRequest {
    ...
    private var pathInfo: String? = null
    ...
    override fun login(arg0: String, arg1: String) {
    ...
    fun setPathInfo(pathInfo: String) {
    ...
    override fun startAsync(arg0: ServletRequest, arg1: ServletResponse): AsyncContext? {
        return null
    }

    @Throws(IOException::class, ServletException::class)
    override fun authenticate(arg0: HttpServletResponse): Boolean {
        return false
    }

    @Throws(IOException::class, ServletException::class)
    override fun getPart(arg0: String): Part? {
        return null
    }
