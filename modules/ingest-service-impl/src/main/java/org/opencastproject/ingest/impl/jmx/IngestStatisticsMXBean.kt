...
interface IngestStatisticsMXBean {
     ...
     */
    val successfulIngestOperations: Int
     ...
     * @return the number of ingest operations
     */
    val failedIngestOperations: Int
     ...
     * @return the number of bytes
     */
    val bytesInLastFiveMinutes: Long
     ...
     * @return the number of bytes
     */
    val bytesInLastFifteenMinutes: Long
