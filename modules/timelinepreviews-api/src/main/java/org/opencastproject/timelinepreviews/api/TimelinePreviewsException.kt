 ...
 */
class TimelinePreviewsException : Exception {
    ...
    /**
     * Creates a new timeline previews exception with `message` as a reason and `cause` as the original
     * cause of failure.
     *
     * @param message
     * the reason of failure
    ...
    companion object {
        ...
        private val serialVersionUID = 8647839276281407395L
    }
