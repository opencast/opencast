...
public class TimelinePreviewsException extends Exception {
  ...
  /**
   * Creates a new timeline previews exception with <code>message</code> as a reason.
   *
   * @param message
  ...
  /**
   * Creates a new timeline previews exception where <code>cause</code> identifies the original reason of failure.
   *
   * @param cause
