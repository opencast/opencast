 ...
 */
@Component(property = { "service.description=Speech to Text Workflow Scheduler" }, immediate = true, service = {
...
public class SpeechToTextWorkflowSchedulerQuartz extends AbstractScanner implements ManagedService {
  ...
  public void updated(Dictionary<String, ?> properties) throws ConfigurationException {
    ...
    if (properties != null) {
      ...
      Option<Boolean> optEnabled = OsgiUtil.getOptCfgAsBoolean(properties, PARAM_KEY_ENABLED);
      setEnabled(optEnabled.isSome() && optEnabled.get());
      if (!isEnabled()) {
  ...
  WorkflowInstance startWorkflow(String mpId, List<JpaJob> jobs) {
    ...
    try {
      ...
      logger.info("Workflow {} {}started for mp {}{}", attachWorkflowDef, wf != null ? "" : "NOT ", mpId,
              wf != null ? ": " + wf.getId() : "");
      return wf;
