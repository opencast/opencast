...
interface Smil : SmilObject {
     ...
     *
     * @return the XML representation of the [Smil] object
     * @throws JAXBException if serializing fail
     */
    @Throws(JAXBException::class, SAXException::class, MalformedURLException::class)
    fun toXML(): String
    ...
    operator fun get(elementId: String): SmilObject
}
