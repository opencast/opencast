 ...
 */
interface SmilMediaContainer : SmilMediaObject {
    ...
    /**
     * Returns media elements or containers inside as [List] of
     * [SmilMediaObject]s. The [List] is immutable, use
     * SmilService to modify it.
     *
     * @return
     */
    val elements: List<SmilMediaObject>
     ...
     */
    fun isParentOf(childId: String): Boolean
}
