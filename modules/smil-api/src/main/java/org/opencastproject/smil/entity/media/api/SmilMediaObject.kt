 ...
 * `audio`, `video`, ... and media containers like `par`,
 * `seq` should implement this interface.
 */
interface SmilMediaObject : SmilObject {

    /**
     * Returns `true` if this element is an container for other media
     * elements.
     *
