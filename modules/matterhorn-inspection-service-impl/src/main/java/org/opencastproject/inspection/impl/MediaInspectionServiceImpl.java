...
public class MediaInspectionServiceImpl extends AbstractJobProducer implements MediaInspectionService, ManagedService {
  ...
  public void activate(ComponentContext cc) {
    // Configure mediainfo
    final String path = cc.getBundleContext().getProperty(MediaInfoAnalyzer.MEDIAINFO_BINARY_CONFIG);
    ...
    inspector = new MediaInspector(workspace, tikaParser, mediaInfoBinary);
  }
  ...
  public void updated(Dictionary properties) throws ConfigurationException {
    if (properties == null)
      return;
    final String path = StringUtils.trimToNull((String) properties.get(MediaInfoAnalyzer.MEDIAINFO_BINARY_CONFIG));
    if (path != null) {
