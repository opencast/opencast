...
/**
 * Provides captioning support. This service makes use of [CaptionConverter] instances that need to be registered
...
interface CaptionService {
    ...
    fun convert(input: MediaPackageElement, inputFormat: String, outputFormat: String): Job
     ...
     */
    @Throws(UnsupportedCaptionFormatException::class, CaptionConverterException::class, MediaPackageException::class)
    fun convert(input: MediaPackageElement, inputFormat: String, outputFormat: String, language: String): Job
    ...
    fun getLanguageList(input: MediaPackageElement, format: String): Array<String>

    companion object {

        val JOB_TYPE = "org.opencastproject.caption"
    }
