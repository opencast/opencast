...
public class Blacklist {
  ...
  public List<Obj> toJson(Option<Long> periodId) {
    ...
    for (Period p : periods) {
      ...
      objArr.add(Jsons.obj(Jsons.p("id", id), Jsons.p("resourceType", type), Jsons.p("resource", b),
              Jsons.p("start", DateTimeSupport.toUTC(p.getStart().getTime())),
              Jsons.p("end", DateTimeSupport.toUTC(p.getEnd().getTime())), Jsons.p("purpose", purpose),
