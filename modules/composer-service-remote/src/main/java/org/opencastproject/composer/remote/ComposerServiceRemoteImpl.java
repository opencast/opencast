...
public class ComposerServiceRemoteImpl extends RemoteBase implements ComposerService {
  ...
  @Override
  public Job concat(String profileId, Dimension outputDimension, float outputFrameRate, boolean sameCodec, Track... tracks)
          throws EncoderException, MediaPackageException {
  ...
  /***
   * An encoding that produces multiple outputs based on profile
   */
  @Override
