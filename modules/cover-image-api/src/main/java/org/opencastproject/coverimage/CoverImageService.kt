...
interface CoverImageService {
    ...
    fun generateCoverImage(xml: String, xsl: String, width: String, height: String, posterImageUri: String, targetFlavor: String): Job

    companion object {

        val JOB_TYPE = "org.opencastproject.coverimage"
    }
