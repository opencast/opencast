...
public class SortCriterionImplTest {
  ...
  private static final SortCriterion orderByNameAsc = new SortCriterionImpl("name", SearchQuery.Order.Ascending);
  private static final SortCriterion orderByNameDesc = new SortCriterionImpl("name", SearchQuery.Order.Descending);
  private static final SortCriterion orderByDateAsc = new SortCriterionImpl("date", SearchQuery.Order.Ascending);
  private static final SortCriterion orderByDateDesc = new SortCriterionImpl("date", SearchQuery.Order.Descending);
  ...
  public void testGetOrder() {
    Assert.assertEquals(SearchQuery.Order.Ascending, orderByNameAsc.getOrder());
    Assert.assertEquals(SearchQuery.Order.Descending, orderByNameDesc.getOrder());
  }
  ...
  public void testEquals() {
    assertTrue(orderByNameAsc.equals(new SortCriterionImpl("name", SearchQuery.Order.Ascending)));
  }

  /** Test method for {@link SortCriterionImpl#hashCode()} */
  @Test
  public void testHashCode() {
    assertEquals(orderByNameAsc.hashCode(), new SortCriterionImpl("name", SearchQuery.Order.Ascending).hashCode());
  }
