 ...
 * A {@link Report}
 */
@XmlType(name = "view-collection", namespace = "http://analytics.opencastproject.org")
@XmlRootElement(name = "view-collection", namespace = "http://analytics.opencastproject.org")
