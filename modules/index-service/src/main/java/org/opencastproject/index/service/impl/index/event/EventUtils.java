...
public final class EventUtils {
    ...
    public static MetadataCollection getEventMetadata(Event event, EventCatalogUIAdapter eventCatalogUIAdapter)
        ...
        if (metadata.getOutputFields().containsKey(DublinCore.PROPERTY_DESCRIPTION.getLocalName())) {
            MetadataField<?> description = metadata.getOutputFields()
                    .get(DublinCore.PROPERTY_DESCRIPTION.getLocalName());
        ...
        if (metadata.getOutputFields().containsKey(DublinCore.PROPERTY_RIGHTS_HOLDER.getLocalName())) {
            MetadataField<?> rightsHolder = metadata.getOutputFields()
                    .get(DublinCore.PROPERTY_RIGHTS_HOLDER.getLocalName());
        ...
        if (metadata.getOutputFields().containsKey(DublinCore.PROPERTY_CONTRIBUTOR.getLocalName())) {
            MetadataField<?> contributors = metadata.getOutputFields()
                    .get(DublinCore.PROPERTY_CONTRIBUTOR.getLocalName());
        ...
        if (metadata.getOutputFields().containsKey(DublinCore.PROPERTY_CREATOR.getLocalName())) {
            MetadataField<String> createdBy = MetadataField.createTextMetadataField("createdBy", Opt.<String>none(),
                    ...
                    Opt.<Map<String, String>>none(), Opt.<String>none(), Opt.some(CREATED_BY_UI_ORDER),
                    Opt.<String>none());
            createdBy.setValue((String) event.getCreator());
