...
public class ContributorsListProviderTest {
  ...
  public void setUp() throws Exception {
    ...
    searchIndex = EasyMock.createNiceMock(OpenSearchIndex.class);
  ...
  public void testUsernamesList() {
    Map<String, String> list = contributorsListProvider.getList(
        ContributorsListProvider.NAMES_TO_USERNAMES, null
    );
  ...
  public void testListSimple() throws ListProviderException {
    Map<String, String> list = contributorsListProvider.getList(
        ContributorsListProvider.DEFAULT, null);
