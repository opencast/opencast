...
class YouTubeUtilsTest {
    ...
    fun testGetWhenRequired() {
        YouTubeUtils.get(XProperties(), YouTubeKey.clientSecretsV3, true)
    }

    @Test(expected = IllegalArgumentException::class)
    fun testGetWhenRequiredByDefault() {
        YouTubeUtils.get(XProperties(), YouTubeKey.clientSecretsV3)
    }

    @Test
    fun testNull() {
        assertNull(YouTubeUtils.get(XProperties(), YouTubeKey.clientSecretsV3, false))
    }
