...
public class PlaylistCurrentUserExtension {
  ...
  @GraphQLField
  @GraphQLNonNull
  @GraphQLDescription("A list of playlists owned by the current user.")
  public GqlPlaylistList myPlaylists(
    ...
    return new PlaylistOffsetDataFetcher()
        .withUser(currentUser.getUser())
        .writeOnly(true)
        .get(environment);
  }
