...
constructor(
         ...
         */
        val name: String // unique key
        , type: Type?, defaultValue: String?, description: String?,
        /**
     ...
     */
    var isPath = false // This will be true for a path parameter.
     ...
     */
    val escapedDefaultValue: String?
        get() = StringEscapeUtils.escapeHtml4(defaultValue)

    /**
     * @return an HTML formatted version of the xml schema for display
     */
    val escapedXmlSchema: String?
        get() = StringEscapeUtils.escapeXml(xmlSchema)
     ...
     */
    constructor(restParam: RestParameter) : this(restParam.name,
