...
public final class Lists {
   ...
   * <p/>
   * Since the implementation is based on the Java Collection classes it cannot make any assumptions about
   * the immutability of <code>t</code> and therefore has to copy it into a new list. Use with care.
   */
