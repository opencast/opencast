...
public interface SMILAnimation extends SMILElement, ElementTargetAttributes, ElementTime, ElementTimeControl {
  ...
  /**
   * A code representing the value of the additive attribute, as defined above. Default value is
   * <code>ADDITIVE_REPLACE</code> .
   * 
  ...
  /**
   * A code representing the value of the accumulate attribute, as defined above. Default value is
   * <code>ACCUMULATE_NONE</code> .
   * 
   * @exception DOMException
   *              NO_MODIFICATION_ALLOWED_ERR: Raised if this attribute is readonly.
   */
  ...
  /**
   * A <code>DOMString</code> representing the value of the keySplines attribute. Need an interface a point
   * (x1,y1,x2,y2)
   * 
   * @exception DOMException
   *              NO_MODIFICATION_ALLOWED_ERR: Raised if this attribute is readonly.
