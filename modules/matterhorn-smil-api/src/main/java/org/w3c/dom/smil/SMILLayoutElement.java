...
public interface SMILLayoutElement extends SMILElement {
  ...
  /**
   * The mime type of the layout langage used in this layout element.The default value of the type attribute is
   * "text/smil-basic-layout".
   */
  public String getType();

  /**
   * <code>true</code> if the player can understand the mime type, <code>false</code> otherwise.
   */
