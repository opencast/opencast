        ...
        try {
          ...
          for (Snapshot snapshot : byOrg.get(orgId)) {
            ...
            try {
              ...
              messageSender.sendObjectMessage(AssetManagerItem.ASSETMANAGER_QUEUE_PREFIX + WordUtils.capitalize(
                      index.getIndexName()), MessageSender.DestinationType.Queue, takeSnapshot);
            } catch (Throwable t) {
