 ...
 */
interface Version : Comparable<Version>, Serializable {
    /** Check if this version is older than `v`.  */
    fun isOlder(v: Version): Boolean

    /** Check if this version is younger than `v`.  */
    fun isYounger(v: Version): Boolean
     ...
     * [org.opencastproject.assetmanager.api.AssetManager.toVersion].
     */
