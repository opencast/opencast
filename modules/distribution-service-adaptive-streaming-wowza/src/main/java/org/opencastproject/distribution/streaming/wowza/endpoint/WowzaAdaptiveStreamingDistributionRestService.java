 ...
 */
@Path("/")
@RestService(name = "streamingdistributionservice", title = "Streaming Distribution Service",
  abstractText = "This service distributes media packages to the streaming server, especially Wowza Streaming Server.",
  notes = {
