        ...
        link: function (scope) {
            ...
            scope.showStatsFilter = function (index) {
                ...
                angular.forEach(scope.stats.stats[index].filters, function (filter) {
                  ...
                  if (filter.hasOwnProperty('relativeDateSpan')) {
                    var value = RelativeDatesService.relativeDateSpanToFilterValue(filter.relativeDateSpan.from, filter.relativeDateSpan.to);
                  }
                  else {
