...
.factory('NewLocationblacklistStates', ['NewLocationblacklistItems', 'NewLocationblacklistDates',
  'NewLocationblacklistReason', 'NewLocationblacklistSummary',
  function (NewLocationblacklistItems, NewLocationblacklistDates, NewLocationblacklistReason,
    NewLocationblacklistSummary) {
    return {
      get: function () {
        return [{
