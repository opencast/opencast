...
.controller('UserblacklistsCtrl', ['$scope', 'Table', 'Notifications', 'UserBlacklistsResource',
  'ResourcesFilterResource', function ($scope, Table, Notifications, UserBlacklistsResource, ResourcesFilterResource) {
