...
public class ThemesEndpoint {
  ...
  public Response getThemes(@QueryParam("filter") String filter, @QueryParam("limit") int limit,
    ...
    SearchResult<org.opencastproject.search.index.theme.Theme> results = null;
    try {
    ...
    for (SearchResultItem<org.opencastproject.search.index.theme.Theme> item : results.getItems()) {
      org.opencastproject.search.index.theme.Theme theme = item.getSource();
  ...
  public Response getThemeResponse(@PathParam("themeId") long id) throws Exception {
    Opt<org.opencastproject.search.index.theme.Theme> theme = getTheme(id);
    if (theme.isNone())
  ...
  public Response getThemeUsage(@PathParam("themeId") long themeId) throws Exception {
    Opt<org.opencastproject.search.index.theme.Theme> theme = getTheme(themeId);
    if (theme.isNone())
   ...
   */
  private Opt<org.opencastproject.search.index.theme.Theme> getTheme(long id) throws SearchIndexException {
    SearchResult<org.opencastproject.search.index.theme.Theme> result = searchIndex
    ...
    if (result.getPageSize() == 0) {
      ...
      return Opt.<org.opencastproject.search.index.theme.Theme> none();
    }
   ...
   */
  private JValue themeToJSON(org.opencastproject.search.index.theme.Theme theme, boolean editResponse) {
