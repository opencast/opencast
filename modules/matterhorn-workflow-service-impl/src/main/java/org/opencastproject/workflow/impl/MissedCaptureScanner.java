...
public class MissedCaptureScanner extends AbstractWorkflowBufferScanner implements ManagedService {
  private static final Log logger = new Log(LoggerFactory.getLogger(MissedCaptureScanner.class));

  public static final String JOB_GROUP = "mh-workflow-find-missed-captures-job-group";
  public static final String JOB_NAME = "mh-workflow-find-missed-captures-job";
  public static final String SCANNER_NAME = "Missed Capture Scanner";
  public static final String TRIGGER_GROUP = "mh-workflow-find-missed-captures-trigger-group";
  public static final String TRIGGER_NAME = "mh-workflow-find-missed-captures-trigger";

  public MissedCaptureScanner() {
    try {
  ...
  public void scan() {
    try {
      getWorkflowService().moveMissingCapturesFromUpcomingToFailedStatus(getBuffer());
