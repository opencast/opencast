...
interface MoodleWebService {
    ...
    fun coreUserGetUsersByField(filter: CoreUserGetUserByFieldFilters, values: List<String>): List<MoodleUser>
     ...
     */
    @Throws(URISyntaxException::class, IOException::class, MoodleWebServiceException::class, ParseException::class)
    fun toolOpencastGetCoursesForInstructor(username: String): List<String>
     ...
     */
    @Throws(URISyntaxException::class, IOException::class, MoodleWebServiceException::class, ParseException::class)
    fun toolOpencastGetCoursesForLearner(username: String): List<String>
     ...
     */
    @Throws(URISyntaxException::class, IOException::class, MoodleWebServiceException::class, ParseException::class)
    fun toolOpencastGetGroupsForLearner(username: String): List<String>

    enum class CoreUserGetUserByFieldFilters {
        id, lastname, firstname, idnumber, username, email, auth
    }

    companion object {
        val MOODLE_FUNCTION_CORE_USER_GET_USERS_BY_FIELD = "core_user_get_users_by_field"
        val MOODLE_FUNCTION_TOOL_OPENCAST_GET_COURSES_FOR_INSTRUCTOR = "tool_opencast_get_courses_for_instructor"
        val MOODLE_FUNCTION_TOOL_OPENCAST_GET_COURSES_FOR_LEARNER = "tool_opencast_get_courses_for_learner"
        val MOODLE_FUNCTION_TOOL_OPENCAST_GET_GROUPS_FOR_LEARNER = "tool_opencast_get_groups_for_learner"
    }
}
