                                    ...
                                    <div className="formik-container">
                                        ...
                                        <div className="row">
                                            <Field name="j_username"
                                                   ...
                                                   className={cn("login-input", {error: (formik.touched.j_username && formik.errors.j_username) || isError})}
                                                   autoFocus="autoFocus"/>
                                        </div>
                                        <div className="row">
                                            <Field name="j_password"
                                                   ...
                                                   className={cn("login-input", {error: (formik.touched.j_password && formik.errors.j_password) || isError})}/>
                                        </div>
