...
class GenericUrlSigningProvider : AbstractUrlSigningProvider() {
    /** The resource strategy to use to convert from the base url to a resource url.  */
    override val resourceStrategy: ResourceStrategy = BasicResourceStrategyImpl()
    ...
    companion object {
        private val logger = LoggerFactory.getLogger(GenericUrlSigningProvider::class.java)
    }
