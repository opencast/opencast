 ...
 */
interface StreamingDistributionService : DistributionService {

    @Throws(DistributionException::class, MediaPackageException::class)
    fun distribute(channelId: String, mediapackage: MediaPackage, elementIds: Set<String>): Job
     ...
     */
    @Throws(DistributionException::class)
    fun distributeSync(channelId: String, mediapackage: MediaPackage, elementIds: Set<String>): List<MediaPackageElement>
