 ...
 */
interface DownloadDistributionService : DistributionService {

    @Throws(DistributionException::class, MediaPackageException::class)
    fun distribute(channelId: String, mediapackage: MediaPackage, elementId: String, checkAvailability: Boolean): Job

    @Throws(DistributionException::class, MediaPackageException::class)
    fun distribute(channelId: String, mediapackage: MediaPackage, elementIds: Set<String>, checkAvailability: Boolean): Job

    @Throws(DistributionException::class, MediaPackageException::class)
    fun distribute(pubChannelId: String, mediaPackage: MediaPackage, downloadIds: Set<String>, checkAvailability: Boolean, preserveReference: Boolean): Job

    @Throws(DistributionException::class)
    fun retract(channelId: String, mediaPackage: MediaPackage, elementIds: Set<String>): Job
     ...
     */
    @Throws(DistributionException::class)
    fun distributeSync(channelId: String, mediapackage: MediaPackage, elementIds: Set<String>, checkAvailability: Boolean): List<MediaPackageElement>
     ...
     */
    @Throws(DistributionException::class)
    fun retractSync(channelId: String, mediaPackage: MediaPackage, elementIds: Set<String>): List<MediaPackageElement>
}
