...
import org.opencastproject.opensearch.api.Language;
 ...
 */
public final class OpenSearchDocument extends HashMap<String, Object> {
   ...
   * <p>
   * Note that the type needs to map to an OpenSearch document type mapping.
   *
   * @param id
   ...
   */
  public OpenSearchDocument(String id, String type, List<SearchMetadata<?>> resource) {
    this.id = id;
    this.type = type;
