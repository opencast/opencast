...
public interface StatisticsExportService {
  ...
  String getCSV(StatisticsProvider provider, String resourceId, Instant from, Instant to, DataResolution dataResolution,
                OpenSearchIndex index, ZoneId zoneId) throws SearchIndexException, UnauthorizedException,
          NotFoundException;
   ...
   */
  String getCSV(StatisticsProvider provider, String resourceId, Instant from, Instant to, DataResolution dataResolution,
          OpenSearchIndex index, ZoneId zoneId, boolean fullMetadata, DetailLevel detailLevel, int limit,
