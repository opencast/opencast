...
public class NodeListImpl implements NodeList {
   ...
   * 
   * @param rootNode
   *          The root <code>Node</code> of the search.
   * @param tagName
   *          The tag name to be searched for. If null, all descendants will be returned.
   * @param deep
   *          Limit the search to the direct children of rootNode if false, to all descendants otherwise.
   */
