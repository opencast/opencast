...
public abstract class ElementParallelTimeContainerImpl extends ElementTimeContainerImpl implements
  ...
  public String getEndSync() {
    ...
    if (ENDSYNC_FIRST.equals(endsync) || ENDSYNC_LAST.equals(endsync) || ENDSYNC_ALL.equals(endsync)
            || ENDSYNC_MEDIA.equals(endsync)) {
      return endsync;
    }
  ...
  public void setEndSync(String endSync) throws DOMException {
    if (ENDSYNC_FIRST.equals(endSync) || ENDSYNC_LAST.equals(endSync) || ENDSYNC_ALL.equals(endSync)
      ...
      throw new DOMException(DOMException.NOT_SUPPORTED_ERR, "Unsupported endsync value" + endSync);
    }
  }
  ...
  public NodeList getActiveChildrenAt(float instant) {
    /*
     * Find the closest Time of ElementTime before instant. Add ElementTime to list of active elements if the Time
     * belongs to the begin-list, do not add it otherwise.
     */
