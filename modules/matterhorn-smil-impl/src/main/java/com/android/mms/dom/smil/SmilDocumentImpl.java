...
public class SmilDocumentImpl extends DocumentImpl implements SMILDocument, DocumentEvent {
  ...
  /*
   * The sequential time container cannot be initialized here because the real container is body, which hasn't been
   * created yet. It will be initialized when the body has already been created. Please see getBody().
   */
  ...
  public SMILElement getDocumentElement() {
    ...
    if (rootElement == null || !(rootElement instanceof SMILElement)
            || !"smil".equals(((SMILElement) rootElement).getTagName())) {
  ...
  public SMILElement getHead() {
    ...
    if (headElement == null || !(headElement instanceof SMILElement)
            || !"head".equals(((SMILElement) headElement).getTagName())) {
  ...
  public SMILElement getBody() {
    ...
    if (bodyElement == null || !(bodyElement instanceof SMILElement)
            || !"body".equals(((SMILElement) bodyElement).getTagName())) {
  ...
  public Event createEvent(String eventType) throws DOMException {
    if ("Event".equals(eventType)) {
      ...
      throw new DOMException(DOMException.NOT_SUPPORTED_ERR, "Not supported interface");
    }
  }
}
